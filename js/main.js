...
for (let i = 1; i <= SIZE * SIZE - 1; i++) {
    ...
    let cellY = Math.floor((i - 1) / SIZE); //const SIZE = 6; //盤面一列のタイル数
const CELL_SIZE = 600 / SIZE; //タイル１辺の長さ
const SPEED = 50; //タイル移動のスピード
const SHUFFLE = 300; //最初のシャッフル数
...
timer=setInterval(cellMoveRand,SPEED)
setTimeout(()=>clearInterval(timer),SPEED*SHUFFLE)
// for (i = 1; i < SHUFFLE; i++) {
//     cellMoveRand();
// }
